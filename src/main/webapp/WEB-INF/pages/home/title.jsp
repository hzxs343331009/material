...
<div id="menuContent">
		...
		<span id="topmenu" onclick="toModule('order');">订单管理</span><span id="tm_separator"></span>
		<span id="topmenu" onclick="toModule('factory');">厂家管理</span><span id="tm_separator"></span>
		<span id="topmenu" onclick="toModule('material');">材料管理</span>
</div>
